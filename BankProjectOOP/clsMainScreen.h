...
#include "clsGlobal.h"
#include "clsLoginRegisteryScreen.h"
...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7, eLoginRegistery = 8, eCurrencyMenue = 9, eExit = 10
    };
    ...
    {
        clsLoginRegisteryScreen::ShowLoginRegisterScreen();
    }
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
        ...
        case enMainMenueOptions::eLoginRegistery:
            system("cls");
...
public:
    ...
    static void ShowMainMenue()
    {
        ...
        cout << setw(37) << left << "" << "\t[8] Login Registery.\n";
